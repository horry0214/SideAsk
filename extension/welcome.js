...
const COPY = {
  en: {
    ...
    providerTitle:"Connect your AI Provider",providerBody:"Choose from 25 presets including OpenAI, Claude, Gemini, OpenRouter, local Ollama, and more. Your API key stays local.",providerMissing:"No browser Provider is configured yet.",addProvider:"Add Provider",refresh:"Refresh",configured:"Configured",providerReady:"{{name}} · {{model}} · saved locally",providerMissingStatus:"Not configured",
  ...
  "zh-CN": {
    ...
    providerTitle:"连接 AI Provider",providerBody:"可从 OpenAI、Claude、Gemini、OpenRouter、本机 Ollama 等 25 个预设中选择，API Key 只保存在本地。",providerMissing:"还没有配置浏览器 Provider。",addProvider:"添加 Provider",refresh:"刷新",configured:"已配置",providerReady:"{{name}} · {{model}} · 已保存在本地",providerMissingStatus:"未配置",
