...
const COPY = {
  en: {
    ...
    providerTitle:"Connect your AI Provider",providerBody:"Configure one of 25 Providers here or in VS Code. The encrypted local Vault is shared on this computer.",providerMissing:"No shared Provider is configured yet.",addProvider:"Add Provider",refresh:"Refresh",configured:"Configured",providerReady:"{{name}} · {{model}} · shared locally",providerMissingStatus:"Not configured",
  ...
  "zh-CN": {
    ...
    disclosureTitle:"在 SideAsk 读取划词内容之前",disclosureBody:"只有你主动选中的文字、少量附近可读上下文、移除 query/hash 的来源 URL，以及当前支线消息，会经由你的本地 Gateway 发送给你选择的 AI Provider。密码、表单字段与编辑器草稿会被排除。Provider Key 加密保存在 Gateway 本机 Vault；最近提问和收藏留在浏览器。SideAsk 不含遥测、广告或云数据库。",privacyLink:"阅读完整隐私政策 ↗",acceptDisclosure:"我已了解，继续设置",acceptedDisclosure:"隐私选择已保存 ✓",
    ...
    providerTitle:"连接 AI Provider",providerBody:"可在这里或 VS Code 中配置 25 个 Provider；本机加密 Vault 会在两个入口之间共享。",providerMissing:"还没有配置共享 Provider。",addProvider:"添加 Provider",refresh:"刷新",configured:"已配置",providerReady:"{{name}} · {{model}} · 已在本机共享",providerMissingStatus:"未配置",
