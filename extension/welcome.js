...
const COPY = {
  en: {
    ...
    readyTitle:"SideAsk is ready.",readyBody:"Select text on any regular web page and choose “✦ Explain”. Your first Learning Branch is already saved locally.",viewDashboard:"View learning dashboard",operationFailed:"SideAsk could not complete that action.",popupBlocked:"Your browser blocked the new tab. Open the dashboard from the extension menu.",accessRemoved:"Website access removed.",practiceNeedsSetup:"Finish Gateway and Provider setup first so the practice answer can load."
  },
  "zh-CN": {
    brandTagline:"问题走支线，思路留主线",dashboard:"打开管理页",eyebrow:"约三分钟完成",heroTitle:"让第一条支线回答真正跑起来。",heroBody:"连接本地 Gateway，添加你已经在用的模型，然后用一次真实划词完成上手。",trustLocal:"✓ 学习记录本地保存",trustKey:"✓ 使用自己的 API Key",trustNoAccount:"✓ 无需 SideAsk 账户",explain:"解释",answerTitle:"问题走支线，不打断主线",answerBody:"回答在原文旁展开，并始终保留来源锚点。",
    disclosureTitle:"在 SideAsk 读取划词内容之前",disclosureBody:"只有你主动选中的文字、少量附近可读上下文、移除 query/hash 的来源 URL，以及当前支线消息，会经由你的本地 Gateway 发送给你选择的 AI Provider。密码、表单字段与编辑器草稿会被排除。Provider Key 和学习记录保存在扩展私有存储中。SideAsk 不含遥测、广告或云数据库。",privacyLink:"阅读完整隐私政策 ↗",acceptDisclosure:"我已了解，继续设置",acceptedDisclosure:"隐私选择已保存 ✓",
    ...
    readyTitle:"SideAsk 已经准备好了。",readyBody:"以后在普通网页中选中文字，再点击“✦ 解释”即可。你的第一条 Learning Branch 已保存在本地。",viewDashboard:"查看学习管理页",operationFailed:"SideAsk 未能完成这个操作。",popupBlocked:"浏览器拦截了新标签页，请从扩展菜单打开管理页。",accessRemoved:"网页访问权已撤销。",practiceNeedsSetup:"请先完成 Gateway 与 Provider 配置，练习页才能得到真实回答。"
  }
};
